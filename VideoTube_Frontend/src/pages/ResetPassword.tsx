          ...
          {[newPassword, confirmPassword].map((value, index) => (
            <div key={index} className="relative">
              ...
              <input
                ...
                required
                className="w-full rounded-xl border border-[var(--border)] bg-[var(--bg-elevated)] py-3 pl-10 pr-11 text-sm outline-none transition-colors focus:border-[var(--accent)]"
              />
              {index === 0 && (
                <button
                  type="button"
